...
// any single character that is not whitespace. Whitespace matches no alternative, so the
 ...
 * @throws {LexError} When the text holds a character that cannot begin a token.
 */
